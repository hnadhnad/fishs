...
public class SkillDraftUI : MonoBehaviour
{
    ...
    public void Show(int numberOfOptions)
    {
        ...
        // Ẩn/hiện các nút theo số lượng
        if (option1Button != null) option1Button.gameObject.SetActive(optionsToShow >= 1);
        if (option2Button != null) option2Button.gameObject.SetActive(optionsToShow >= 2);
        if (option3Button != null) option3Button.gameObject.SetActive(optionsToShow >= 3);
