...
public class BossPhase2State : IBossState
{
    ...
    private void SpawnBomb(Boss boss, Vector3 targetPosition)
    {
        ...
        // Config bomb
        bomb.Configure(
            boss.phase2BombDelay,          // float - thời gian cảnh báo
            boss.phase2BombRadius,         // float - bán kính nổ
            boss.phase2BombDamage,         // float - lượng máu boss mất
            boss.meatPrefab,               // GameObject - prefab thịt
            boss.phase2MeatCount,          // int - số lượng thịt spawn
            boss.phase2MeatScatterRadius,  // float - bán kính scatter
            boss.phase2BossStunDuration    // float - thời gian stun boss
        );
