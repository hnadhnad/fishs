...
public class Boss : MonoBehaviour
{
    ...
    // ⚡ Tốc độ di chuyển chung (dùng cho retreat, reentry, v.v.)
    [Header("Boss Movement")]
    public float moveSpeed = 4f;
    public float chaseLureSpeed = 6f; // tốc độ dí lure
    ...
    public float phase1BulletSpawnOffset = 1.5f; // khoảng cách spawn đạn trước mặt boss
