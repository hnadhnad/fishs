...
public class BossPhase2State : IBossState
{
    ...
    private void SpawnBomb(Boss boss, Vector3 targetPosition)
    {
        ...
        // Config bomb
        bomb.Configure(
            boss.phase2BombDelay,          // thời gian chờ trước khi nổ
            boss.phase2BombRadius,         // bán kính nổ
            boss.phase2BombDamage,         // damage boss mất khi trúng
            boss.meatPrefab,               // prefab thịt
            boss.phase2MeatCount,          // số miếng thịt spawn
            boss.phase2MeatScatterRadius,  // khoảng cách thịt spawn
