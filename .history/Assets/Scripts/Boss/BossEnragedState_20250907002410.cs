...
public class BossEnragedState : IBossState
{
    ...
    private void SpawnColumn(Boss boss, MapManager map)
    {
        ...
        float minY = map.bottomLeft.y + boss.insideColumnBottomMargin;
        float maxY = map.topRight.y - boss.insideColumnTopMargin;
        ...
        // spacing = khoảng cách chia đều giữa các slot
